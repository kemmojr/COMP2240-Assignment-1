...
public class A1 {
    ...
    static private int dispatchTime, quantumTimeHPC, quantumTimeLPC;
    static private ArrayList<SchedulerProcess> processes, FCFSProcessed, FCFSTimes, SPNProcessed, SPNTimes, PPProcessed, PPTimes, PRRProcessed, PRRTimes;
    ...
    private static void updateReadyQueue(ArrayList<SchedulerProcess> temp, ArrayList<SchedulerProcess> readyQueue, int time){
        int numToRemove = 0;
    ...
    public static boolean insertSorted(int j, ArrayList<SchedulerProcess> list, SchedulerProcess inserting){//insert a SchedulerProcess in it's correct position in an ArrayList
    ...
    private static ArrayList<SchedulerProcess> updateReadyQueueSorted(ArrayList<SchedulerProcess> temp, ArrayList<SchedulerProcess> readyQueue, int time){//update the ready queue with elements that are sorted by priority
    ...
    public static void addProcessBackPP(SchedulerProcess processing, ArrayList<SchedulerProcess> readyQueue){//Adds a process that was executing back into the readyQueue
    ...
    public static void addProcessBack(SchedulerProcess s, ArrayList<SchedulerProcess> readyQueue){
        readyQueue.add(s);
    }

    public static void FCFS(){//Execute the first come first served algorithm
    ...
    public static void SPN(){//Execute the shortest process next algorithm
        ArrayList<SchedulerProcess> temp = new ArrayList<>(processes);//A temporary list of all of the processes
    ...
    public static void PP() {//Execute the pre-emptive priority algorithm
    ...
    public static void getOutput(){//display the output formatted as it was in the output files given
        String algName = "";
    ...
    private static class SchedulerProcess{
        ...
        public SchedulerProcess(SchedulerProcess s){//copy constructor
            ...
            this.turnAroundTime = s.turnAroundTime;
            this.waitingTime = s.waitingTime;
            this.isHPC = s.isHPC;
        }
